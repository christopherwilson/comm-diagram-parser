...
# class TestOldParseLine(unittest.TestCase):
#     def test_basic(self):
#         line = "{h}{f} = {g}"
#         expected = [
#             (2, 1, ["{h}", "{f}"]),
#             (1, 1, ["{g}"])
#         ]
#         parser = MapsParserOld("testfiles/blank.txt")
...
#         parser = MapsParserOld("testfiles/blank.txt")
#         parser.funcs["{f}"] = (2, 3)
#         result = parser.parse_line(line, 1)[1]
...
#         parser = MapsParserOld("testfiles/blank.txt")
#         parser.funcs["{h}"] = (2, 3)
#         result = parser.parse_line(line, 1)[2]
#         self.assertEquals(3, result)
#
#
# class TestOldParseFile(unittest.TestCase):
#     def test_triangle(self):
#         g = nx.DiGraph([(0, 1), (1, 2), (0, 2)])
#         parser = MapsParserOld("testfiles/blank.txt")
#         result_eq_heads, result_list = parser.parse_file("testfiles/morphisms_txt/triangle.txt")
#         print((result_eq_heads, result_list))
#         self.assertEqual([], result_eq_heads)
#         self.assertEqual([[]], result_list)
#         self.assertTrue(nx.is_isomorphic(g, parser.get_graph()))
#
#     def test_square(self):
#         g = nx.DiGraph([(0, 1), (1, 2), (0, 3), (3, 2)])
#         parser = MapsParserOld("testfiles/blank.txt")
#         result_eq_heads, result_list = parser.parse_file("testfiles/morphisms_txt/square.txt")
#         print((result_eq_heads, result_list))
#         self.assertEqual([], result_eq_heads)
#         self.assertEqual([[]], result_list)
#         self.assertTrue(nx.is_isomorphic(g, parser.get_graph()))
#
#     def test_exfig(self):
#         g = nx.DiGraph([(0, 1), (1, 2), (0, 2), (3, 1), (3, 2)])
#         parser = MapsParserOld("testfiles/blank.txt")
#         result_eq_heads, result_list = parser.parse_file("testfiles/morphisms_txt/exfig.txt")
#         print((result_eq_heads, result_list))
#         self.assertEqual([], result_eq_heads)
#         self.assertEqual([[], []], result_list)
#         self.assertTrue(nx.is_isomorphic(g, parser.get_graph()))
#
#     def test_dome(self):
#         g = nx.DiGraph([(0, 1), (0, 3), (2, 1)])
#         parser = MapsParserOld("testfiles/blank.txt")
#         result_eq_heads, result_list = parser.parse_file("testfiles/morphisms_txt/dome.txt")
#         print((result_eq_heads, result_list))
#         self.assertEqual([(3, 0, ["{h}", "{g}", "{f}"])], result_eq_heads)
#         self.assertEqual([[]], result_list)
#         self.assertTrue(nx.is_isomorphic(g, parser.get_graph()))
