...
In general, we have to define the starting position and direction of the arrows ourselves, but some packages such as CoDi %cite
and DCpic %cite
...
Dedicated graphical editors for creating commutative diagrams with the tikzcd package, such as quiver %cite
and tikzcd-editor, %cite
